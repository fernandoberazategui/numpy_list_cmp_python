...
if __name__ == '__main__':
    ...
    # potencia_2 = lambda x:......
    # pot_3 = potencia_2(3)
    parametro_potencia_2 = int(input('Ingrese parámetro para la función Potencia_2: '))
    potencia_2 = lambda x: x**2
    print(potencia_2(parametro_potencia_2))
    ...
    print('Función Numeros_potencia de la lista números es: ', numeros_potencia)
