...
if __name__ == '__main__':
    ...
    print('Lista de 11 números entre el 0 y el 10 generada con comprensión de listas: ',lista_0_10)
    ...
    print('Lista de 11 números formados con la tabla del 5: ',tabla_5)
    ...
    print('Lista formada por 10 días aleatorios del mes: ',dias_mes)
